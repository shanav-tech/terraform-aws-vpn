...
module "vpn" {
  source                                    = "git::https://github.com/shanav-tech/terraform-aws-vpn.git?ref=v1.0.0"
  name                                      = local.name
...
## Examples
For detailed examples on how to use this module, please refer to the [examples](https://github.com/shanav-tech/terraform-aws-vpn/tree/master/_example) directory within this repository.

## License
This Terraform module is provided under the **MIT** License. Please see the [LICENSE](https://github.com/shanav-tech/terraform-aws-vpn/blob/master/LICENSE) file for more details.
...
| <a name="input_managedby"></a> [managedby](#input\_managedby) | ManagedBy, eg 'shanav-tech' or 'shanav-tech'. | `string` | `"shanav-tech"` | no |
